...
object ScreenUtils {
    ...
    fun drawCenterText(
        ...
        val paint = Paint().apply {
            ...
            textSize = text_size* scaleFactor
//            color =context.resources.getColor(R.color.text_color, FTApp.getInstance().theme)
            color =Color.GRAY
            style = Paint.Style.FILL
            typeface =  ResourcesCompat.getFont(context, R.font.lora_italic)
        }
